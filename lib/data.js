...
export const menuCategories = [
  { id: "food", name: "Food", parentId: "", description: "Burgers, pizza, sandwiches, and shawarma" },
  { id: "burgers", name: "Burgers", parentId: "food", description: "House-grilled signatures" },
  { id: "pizza", name: "Pizza", parentId: "food", description: "Hot house pizza" },
  { id: "sandwiches", name: "Sandwiches", parentId: "food", description: "Toasted house sandwiches" },
  { id: "shawarma", name: "Shawarma", parentId: "food", description: "Wrapped house favorites" },
  { id: "drinks", name: "Drinks", parentId: "", description: "Refreshments and cocktails" },
  { id: "shakes", name: "Shakes", parentId: "drinks", description: "Creamy milkshakes" },
  { id: "mojito", name: "Mojito", parentId: "drinks", description: "Fresh mojito mixes" },
  { id: "cocktails", name: "Alcoholic Cocktails", parentId: "drinks", description: "House cocktail selection" }
];
