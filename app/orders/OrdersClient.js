...
export default function OrdersClient() {
  ...
  const visibleItems = useMemo(() => menuItems.filter((item) => category === "all" || item.category === category), [category]);
